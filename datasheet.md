# Datasheet for dataset "Fluorescent Neuronal Cells dataset - v2"
...
Please provide a description._
    ...
    Many life science studies relies on human operators that look at fluorescence microscopy images and try to recocgnize and count biological structures of interest. This dataset is created to support applications using this imaging technique and targeting neuronal cells by providing annotated data in various formats, so to enable the development of automated approaches based on supervised learning.

    Potential anticipated extensions may regard:
     - usage for fluorescence microscopy images involving other biological structures
     - usage for neuronal cells pictures acquired with a different imaging techinque
...
<pre>
The dataset was curated by the Fluocells Lab, a collaboration between the Italian National Institute of Nuclear Physics (INFN) and the University of Bologna. For more details and authors list, please visit the <a href="http://amsacta.unibo.it/6706/ ">official repository</a>.
</pre>
...
### What do the instances that comprise the dataset represent (e.g., documents, photos, people, countries)?
    ...
    The fundamental data units are mouse brain slices. Multiple pictures may be acquired for each slice by applying different light wavelenght filters to the fluorescence microscope before taking the shot. In our experiment, each slice produces from one to a maximum of three pictures. When multiple images exist of the same slice, they are stored under a folder named after the corresponding marker and all share the same filename.
...
provide a description._
    ...
    # TODO:
    Each instance is an image.

### Is there a label or target associated with each instance?

_If so, please provide a description._

    Each image is associated with ground-truth labels. Multiple formats are provided:
        ? binary mask RLE encording (to implement + check size)
        - json (decide specific format) with polygon annotations for semantic segmentation
        ? json (decide specific format) with polygon annotations for instance segmentation
        - json (decide specific format) with bounding box annotations for object detection
        - json (decide specific format) with dot annotations for object detection
        - int label for object counting
...
_If so, please provide a description of these splits, explaining the rationale behind them._
    ...
    Data split is pre-made and considered fixed for reproducibility reasons. This was done randomly, except for macaroon artifact that was intentionally included in the test set for testing purposes.
...
DESCRIBE BETTER/MORE DETAILS? + ADD EPIFLUORECENCE REFERENCE ALSO ABOVE
</pre>
...
inferred/derived from other data, was the data validated/verified? If so, please describe how._
    ...
    # TODO: Ask Luppi to describe acquisition process (better if report from thesis and let him check)

### What mechanisms or procedures were used to collect the data (e.g., hardware apparatus or sensor, manual human curation, software program, software API)?

    # TODO: recover details from thesis: camera, zoom, resolution, scale, ...

_How were these mechanisms or procedures validated?_

    # TODO: Ask Luppi for validation procedures
...
associated with the instances was created._
    ...
    # TODO: 
    The original data were acquired in <year> during the experiment <link to source or paper>. The corresponding ground-truth annotations were collected later with the following scheme:
        - 2021: CTB dataset --> Fluorescent Neuronal Cells Dataset V1
        - 2023: c-FOS dataset --> Fluorescent Neuronal Cells Dataset V2
        ? 2023: CTB dataset --> Fluorescent Neuronal Cells Dataset V2
        - 2023: Orx dataset --> Fluorescent Neuronal Cells Dataset V2
...
### Any other comments?
    ...
    # TO DO: link to data collection protocols
...
this section._
    ...
    # TODO: Ask Luppi + decide sharing format (tiff VS png....)
...
_If so, please provide a description._
    ...
    # TODO: articulate description

### Is there a repository that links to any or all papers or systems that use the dataset?

_If so, please provide a link or other access point._

    # TODO: provide existing links
...
harms?_
    ...
    # TODO: think about possible implications
...
_If so, please provide a description._
    ...
    # TODO: decide about the sharing platform
...
### Who is supporting/hosting/maintaining the dataset?
    ...
    The dataset is thought as a static artifact, and maintenance is not foreseen in the short period. However, maintenance interventions will be performed by the Fluocells Lab in case of major errors on a best effort basis.
